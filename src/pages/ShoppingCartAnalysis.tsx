...
import { ShoppingCart, ArrowLeft, CheckCircle2, Lightbulb } from 'lucide-react'
import CodeBlock from '../components/CodeBlock'
import StepIndicator from '../components/StepIndicator'
import InsightsCard from '../components/InsightsCard'
import { projects } from '../utils/data'

const ShoppingCartAnalysis: React.FC = () => {
  const project = projects.find(p => p.id === 'shopping-cart')!

  return (
    <div className="min-h-screen">
      {/* Header */}
      <section className="bg-gradient-to-br from-blue-500 to-cyan-500 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">购物车分析</h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">按照以下步骤完成购物车数据分析</p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.filter(p => p.id !== 'shopping-cart').map((p) => (
              <Link
                key={p.id}
                to={p.path}
